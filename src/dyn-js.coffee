...
Dyn = (opts) ->
  ...
  messaging.delivery.count            = (starttime, startdate, endtime, enddate, startindex, sender, XHeaderName) -> callWithError messaging.delivery._count._call(messaging, {}, _.defaults({starttime:starttime, endtime:endtime}, {apikey:messaging.defaults.apikey})), "delivery.count", msgIsOk, extractMsgData, throwMsgMessages
  messaging.delivery.list             = (starttime, startdate, endtime, enddate, startindex, sender, XHeaderName) -> callWithError messaging.delivery._list._call(messaging, {}, _.defaults({starttime:starttime, startdate:startdate, endtime:endtime}, {apikey:messaging.defaults.apikey})), "delivery.list", msgIsOk, extractMsgData, throwMsgMessages

  messaging.sent_mail                 = crudReportsSentMail()
  messaging.sent_mail.count           = (starttime, startdate, endtime, enddate, startindex, sender, XHeaderName) -> callWithError messaging.sent_mail._count._call(messaging, {}, _.defaults({}, {apikey:messaging.defaults.apikey})), "sent_mail.count", msgIsOk, extractMsgData, throwMsgMessages
  messaging.sent_mail.list            = (starttime, startdate, endtime, enddate, startindex, sender, XHeaderName) -> callWithError messaging.sent_mail._list._call(messaging, {}, _.defaults({starttime:starttime, startdate:startdate, endtime:endtime, enddate:enddate, startindex:startindex||'0', sender:sender, XHeaderName:XHeaderName}, {apikey:messaging.defaults.apikey})), "sent_mail.list", msgIsOk, extractMsgData, throwMsgMessages

  messaging.bounces                   = crudReportsBounces()
  messaging.bounces.count             = (starttime, endtime, startdate, enddate, sender, XHeaderName)                                                  -> callWithError messaging.bounces._count._call(messaging, {}, _.defaults({starttime:endtime, endtime:endtime}, {apikey:messaging.defaults.apikey})), "bounces.count", msgIsOk, extractMsgData, throwMsgMessages
  messaging.bounces.list              = (starttime, endtime, startdate, enddate, startindex, sender, emailaddress, bouncetype, noheaders, XHeaderName) -> callWithError messaging.bounces._list._call(messaging, {}, _.defaults({starttime:starttime, endtime:endtime}, {apikey:messaging.defaults.apikey})), "bounces.list", msgIsOk, extractMsgData, throwMsgMessages

  messaging.complaints                = crudReportsComplaints()
  messaging.complaints.count          = (starttime, endtime, startdate, enddate, sender, XHeaderName)             -> callWithError messaging.complaints._count._call(messaging, {}, _.defaults({starttime:endtime, endtime:endtime}, {apikey:messaging.defaults.apikey})), "complaints.count", msgIsOk, extractMsgData, throwMsgMessages
  messaging.complaints.list           = (starttime, endtime, startdate, enddate, startindex, sender, XHeaderName) -> callWithError messaging.complaints._list._call(messaging, {}, _.defaults({starttime:starttime, endtime:endtime}, {apikey:messaging.defaults.apikey})), "complaints.list", msgIsOk, extractMsgData, throwMsgMessages

  messaging.issues                    = crudReportsIssues()
  messaging.issues.count              = (starttime, endtime, startdate, enddate)             -> callWithError messaging.issues._count._call(messaging, {}, _.defaults({starttime:starttime, endtime:endtime}, {apikey:messaging.defaults.apikey})), "issues.count", msgIsOk, extractMsgData, throwMsgMessages
  messaging.issues.list               = (starttime, endtime, startdate, enddate, startindex) -> callWithError messaging.issues._list._call(messaging, {}, _.defaults({starttime:starttime, endtime:endtime}, {apikey:messaging.defaults.apikey})), "issues.list", msgIsOk, extractMsgData, throwMsgMessages

  messaging.opens                     = crudReportsOpens()
  messaging.opens.count               = (starttime, endtime, startdate, enddate, XHeaderName)             -> callWithError messaging.opens._count._call(messaging, {}, _.defaults({starttime, endtime:endtime}, {apikey:messaging.defaults.apikey})), "opens.count", msgIsOk, extractMsgData, throwMsgMessages
  messaging.opens.list                = (starttime, endtime, startdate, enddate, startindex, XHeaderName) -> callWithError messaging.opens._list._call(messaging, {}, _.defaults({starttime:starttime, endtime:endtime}, {apikey:messaging.defaults.apikey})), "opens.list", msgIsOk, extractMsgData, throwMsgMessages
  messaging.opens.unique              = (starttime, endtime, startdate, enddate, startindex, XHeaderName) -> callWithError messaging.opens._unique._call(messaging, {}, _.defaults({starttime:starttime, endtime:endtime}, {apikey:messaging.defaults.apikey})), "opens.unqiue", msgIsOk, extractMsgData, throwMsgMessages
  messaging.opens.unique_count        = (starttime, endtime, startdate, enddate, startindex, XHeaderName) -> callWithError messaging.opens._unique_count._call(messaging, {}, _.defaults({starttime, endtime:endtime}, {apikey:messaging.defaults.apikey})), "opens.unique_count", msgIsOk, extractMsgData, throwMsgMessages

  messaging.clicks                    = crudReportsClicks()
  messaging.clicks.count              = (starttime, endtime, startdate, enddate, XHeaderName)             -> callWithError messaging.clicks._count._call(messaging, {}, _.defaults({starttime, endtime:endtime}, {apikey:messaging.defaults.apikey})), "clicks.count", msgIsOk, extractMsgData, throwMsgMessages
  messaging.clicks.list               = (starttime, endtime, startdate, enddate, startindex, XHeaderName) -> callWithError messaging.clicks._list._call(messaging, {}, _.defaults({starttime:starttime, endtime:endtime}, {apikey:messaging.defaults.apikey})), "clicks.list", msgIsOk, extractMsgData, throwMsgMessages
  messaging.clicks.unique             = (starttime, endtime, startdate, enddate, startindex, XHeaderName) -> callWithError messaging.clicks._unique._call(messaging, {}, _.defaults({starttime:starttime, endtime:endtimes}, {apikey:messaging.defaults.apikey})), "clicks.unique", msgIsOk, extractMsgData, throwMsgMessages
  messaging.clicks.unique_count       = (starttime, endtime, startdate, enddate, XHeaderName)             -> callWithError messaging.clicks._unique_count._call(messaging, {}, _.defaults({starttime, endtime:endtime}, {apikey:messaging.defaults.apikey})), "clicks.unique_count", msgIsOk, extractMsgData, throwMsgMessages
