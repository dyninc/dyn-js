...
(function() {
  'use strict';
  var Dyn, _, _request_q, callWithError, concat, crudAccounts, crudGslb, crudGslbRegion, crudHttpRedirect, crudJob, crudMessaging, crudNode, crudRecipients, crudRecord, crudReportsBounces, crudReportsClicks, crudReportsComplaints, crudReportsDelivered, crudReportsIssues, crudReportsOpens, crudReportsSentMail, crudSendMail, crudSenders, crudSuppressions, crudTraffic, crudZone, extract, extractData, extractMsgData, extractMsgs, extractRecords, extractZones, failBool, https, identity, isOk, log, makePromise, msgIsOk, okBool, q, qs, safeparse, throwMessages, throwMsgMessages, throwResponse;
  ...
  _request_q = function(dyn, method, path, body, isTraffic) {
    ...
    req = https.request(opts, function(res) {
      var concatStream, handleDone, handleError;
      handleError = function(err) {
        log.silly('dyn', err.message);
        return cc(err);
      };
      handleDone = function(buffer) {
        var response;
  ...
  Dyn = function(opts) {
    ...
    traffic.job = crudJob();
    traffic.job.get = function(id) {
      return callWithError(traffic.job._get._call(traffic, {
        zone: traffic.defaults.zone,
        id: id
      }, {}), "job.get", isOk, extractData, throwMessages);
    };
    traffic.node = crudNode();
    traffic.node.destroy = function(fqdn) {
      return callWithError(traffic.node._destroy._call(traffic, {
        zone: traffic.defaults.zone,
        fqdn: fqdn
